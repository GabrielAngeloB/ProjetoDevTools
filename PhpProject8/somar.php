...
<body style="background-color:#333333;">
    ...
    <div class="card-body">
        <h2 class="card-title text-center">Calculadora de Soma</h2>
        ...
        <button type="button" style='text-align:center;  margin-left:43%;' class="btn btn-primary w-100" onclick="somar()">Somar</button>
