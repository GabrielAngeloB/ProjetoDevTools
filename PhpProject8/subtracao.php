...
<html lang="pt-br">
    ...
    <body style="background-color:#333333;">
        ...
        <div class="card shadow-sm" style="width: 500px; margin:auto; color:white;">
            <div class="card-body">
                <h2 class="card-title text-center">Calculadora de Subtração</h2>
                <p class="card-text" style='text-align:center; font-size:20px'>Entre com dois números e clique em "Subtrair".</p>
                ...
                <button type="button" style='text-align:center;  margin-left:43%;' class="btn btn-primary w-100" onclick="somar()">Subtrair</button>
