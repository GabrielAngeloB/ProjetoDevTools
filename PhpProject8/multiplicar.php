...
<html lang="pt-br">
    ...
    <body style="background-color:#333333;">
        ...
        <div class="card shadow-sm" style="width: 500px; margin:auto; color:white;">
            <div class="card-body">
                <h2 class="card-title text-center">Calculadora de Multiplicação</h2>
                <p class="card-text" style='text-align:center; font-size:20px'>Entre com dois números e clique em "Multiplicar".</p>
